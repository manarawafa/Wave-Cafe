            ...
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <form action="{{route('updatebeverage',[$Beverage->id])}}" method="post" id="demo-form2"
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    ...
                                    <input type="text" id="title" name="title" value="{{$Beverage->title}}"
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    ...
                                    <input type="number" id="price" name="price" value="{{$Beverage->price }}"
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <input type="file" name="image" class="course form-control">{{$Beverage->image}}
                                    <<input type="hidden" id="img" value="{{$Beverage->image}}" name="img">
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    ...
                                    <select class="form-control" name="category" id="">
                                        ...
                                        <option value="{{$Beverage->category_id}}"></option>
