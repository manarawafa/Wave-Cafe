            ...
            <div class="col-md-3 left_col">
                <div class="left_col scroll-view">
                    <div class="navbar nav_title" style="border: 0;">
                        <a href="{{route('drink')}}" class="site_title"><i class="fa fa-graduation-cap"></i></i>
                            <span>Beverages
                                Admin</span></a>
                    </div>
                            ...
                            <ul class="nav side-menu">
                                <li><a><i class="fa fa-users"></i> Users <span class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu">
                                        <li><a href="{{route('uos')}}">Users List</a></li>
                                ...
                                <li><a><i class="fa fa-edit"></i> Categories <span
                                    ...
                                    <ul class="nav child_menu">
                                        <li><a href="{{route('categorycreate')}}">Add Category</a></li>
                                ...
                                <li><a><i class="fa fa-desktop"></i> Beverages <span
                                            class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu">
                                        <li><a href="{{route('beveragecreate')}}">Add Beverage</a></li>
                                        <li><a href="{{route('beverage')}}">Beverages List</a></li>
                                    </ul>
                                </li>
                                <li><a><i class="fa fa-desktop"></i> Messages <span
                                            class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu">
